      ...
      <div class="board">
        ...
        <div class="sb_contents">
          <div class="mb-3">
            ...
            <!--이미지 파일 보여주기 및 삭제-->
            <c:forEach items="${studyBoardDTO.testFileDTOs}" var="fileDTO">
            	<div>
            		<img alt="" src="http://20.249.88.100/resources/test/${fileDTO.f_name}">
                <button type="button" id="delImg" data-name="${fileDTO.f_name}" data-path="test">파일삭제 ${fileDTO.num}</button>
            	</div>
            </c:forEach>
