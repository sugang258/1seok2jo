        ...
        <div class="col mx-5" style="border: 2px solid #aed581;">      
            <div class="row my-2">
                ...
                <div class="col text-end">
                    <a href="${paymentDTO.p_receipt}" >매출전표보기</a>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <td>여러개
                                <div class="row g-1 p-3 align-items-center">
                                    ...
                                    <div class="col-9">
                                      ...
                                      <label for="name" class="text-muted">${orderdto.lecture.id}</label>
                                      <p>${orderdtolecture.l_name}</p>
                                    </div>
                                  </div>
                            </td>
                            <td>여러개
                    ...
                    <tbody>
                        <tr>
                            <td>
                                ...
                                <span class="text-muted">사용 마일리지</span> ${paymentDTO.p_point}마일리지
