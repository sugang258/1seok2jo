...
addvideos.addEventListener("click",function(event){
    ...
    sub.addEventListener("click",function(){
        ...
        if(!(titleCheck && contentCheck && categoryCheck && fileCheck && levelCheck && dateCheck && priceCheck && oturlCheck && ottitleCheck)) {
            alert("모든 칸을 작성해주세요");

            console.log(titleCheck +""+ contentCheck +""+ categoryCheck +""+ levelCheck +""+ dateCheck +""+ priceCheck +""+ oturlCheck +""+ ottitleCheck)
        }else{
